    ...
    timely::execute_from_args(std::env::args(), |worker| {
        ...
        let probe = worker.dataflow(|scope|
            scope.input_from(&mut input)
                ...
                .sarge_exchange()
                .sarge_map(11180000000, move |x| {
                    ref_thread_local! {
                        static managed cam : videoio::VideoCapture = videoio::VideoCapture::new_from_file_with_backend("video-data/test-video.mp4",videoio::CAP_ANY).unwrap();
                    }
