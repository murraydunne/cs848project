...
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn.hpp"
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn/all_layers.hpp"
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn/dict.hpp"
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn/dnn.hpp"
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn/layer.hpp"
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn/shape_utils.hpp"
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn/utils/inference_engine.hpp"
#include "/Users/calumbruton/.cargo/registry/src/github.com-1ecc6299db9ec823/opencv-0.26.6/headers/4.1/opencv2/dnn/version.hpp"
...
// boxed class: cv::dnn::ClassificationModel
void cv_ClassificationModel_delete(void* instance) {
    delete reinterpret_cast<cv::dnn::ClassificationModel*>(instance);
}
// parsed: cv::dnn::ClassificationModel::ClassificationModel
// as:     cv::dnn::ClassificationModel::ClassificationModel (constructor) cv::dnn::ClassificationModel . new
// Arg ARG string model= string = 
// Arg ARG string config= string = ""
// Return value: cv::dnn::ClassificationModel (boxed)
cv_return_value_void_X cv_dnn_ClassificationModel_ClassificationModel_String_String(const char* model, const char* config) {
    try {
        cv::dnn::ClassificationModel* ret = new cv::dnn::ClassificationModel(String(model), String(config));
        return { Error::Code::StsOk, NULL, ret };
    } CVRS_CATCH(cv_return_value_void_X)
}
...
// parsed: cv::dnn::ClassificationModel::ClassificationModel
// as:     cv::dnn::ClassificationModel::ClassificationModel (constructor) cv::dnn::ClassificationModel . new
// Arg ARG cv::dnn::Net (boxed) network= cv::dnn::Net (boxed) = 
// Return value: cv::dnn::ClassificationModel (boxed)
cv_return_value_void_X cv_dnn_ClassificationModel_ClassificationModel_Net(void* network) {
    try {
...
// parsed: cv::dnn::ClassificationModel::classify
// as:     cv::dnn::ClassificationModel::classify (method) cv::dnn::ClassificationModel . classify
// Arg ARG cv::_InputArray (boxed) frame= cv::_InputArray (boxed) = 
// Arg ARG Primitive(int) classId= Primitive(int) = 
// Arg ARG Primitive(float) conf= Primitive(float) = 
// Return value: Primitive(void)
cv_return_value_void cv_dnn_ClassificationModel_classify__InputArray_int_float(void* instance, void* frame, int& classId, float& conf) {
    try {
...
// boxed class: cv::dnn::DetectionModel
void cv_DetectionModel_delete(void* instance) {
    delete reinterpret_cast<cv::dnn::DetectionModel*>(instance);
}
// parsed: cv::dnn::DetectionModel::DetectionModel
// as:     cv::dnn::DetectionModel::DetectionModel (constructor) cv::dnn::DetectionModel . new
// Arg ARG string model= string = 
// Arg ARG string config= string = ""
// Return value: cv::dnn::DetectionModel (boxed)
cv_return_value_void_X cv_dnn_DetectionModel_DetectionModel_String_String(const char* model, const char* config) {
    try {
        cv::dnn::DetectionModel* ret = new cv::dnn::DetectionModel(String(model), String(config));
        return { Error::Code::StsOk, NULL, ret };
    } CVRS_CATCH(cv_return_value_void_X)
}
...
// Arg ARG cv::dnn::Net (boxed) network= cv::dnn::Net (boxed) = 
// Return value: cv::dnn::DetectionModel (boxed)
cv_return_value_void_X cv_dnn_DetectionModel_DetectionModel_Net(void* network) {
    try {
...
// parsed: cv::dnn::DetectionModel::detect
// as:     cv::dnn::DetectionModel::detect (method) cv::dnn::DetectionModel . detect
// Arg ARG cv::_InputArray (boxed) frame= cv::_InputArray (boxed) = 
// Arg ARG Vector[Primitive(int)] classIds= Vector[Primitive(int)] = 
// Arg ARG Vector[Primitive(float)] confidences= Vector[Primitive(float)] = 
// Arg ARG Vector[cv::Rect (simple)] boxes= Vector[cv::Rect (simple)] = 
// Arg ARG Primitive(float) confThreshold= Primitive(float) = 0.5f
// Arg ARG Primitive(float) nmsThreshold= Primitive(float) = 0.0f
// Return value: Primitive(void)
cv_return_value_void cv_dnn_DetectionModel_detect__InputArray_VectorOfint_VectorOffloat_VectorOfRect_float_float(void* instance, void* frame, void* classIds, void* confidences, void* boxes, float confThreshold, float nmsThreshold) {
    try {
...
// parsed: cv::dnn::Model::setInputSize
// as:     cv::dnn::Model::setInputSize (method) cv::dnn::Model (trait) . setInputSize
// Arg ARG cv::Size (simple) size= cv::Size (simple) = 
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_setInputSize_Size(void* instance, SizeWrapper size) {
    try {
        cv::dnn::Model ret = reinterpret_cast<cv::dnn::Model*>(instance)->setInputSize(*reinterpret_cast<const cv::Size*>(&size));
        return { Error::Code::StsOk, NULL, new cv::dnn::Model(ret) };
    } CVRS_CATCH(cv_return_value_void_X)
}
...
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_setInputSize_int_int(void* instance, int width, int height) {
    try {
...
// parsed: cv::dnn::Model::setInputMean
// as:     cv::dnn::Model::setInputMean (method) cv::dnn::Model (trait) . setInputMean
// Arg ARG cv::Scalar (simple) mean= cv::Scalar (simple) = 
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_setInputMean_Scalar(void* instance, ScalarWrapper mean) {
    try {
        cv::dnn::Model ret = reinterpret_cast<cv::dnn::Model*>(instance)->setInputMean(*reinterpret_cast<const cv::Scalar*>(&mean));
        return { Error::Code::StsOk, NULL, new cv::dnn::Model(ret) };
    } CVRS_CATCH(cv_return_value_void_X)
}

// parsed: cv::dnn::Model::setInputScale
// as:     cv::dnn::Model::setInputScale (method) cv::dnn::Model (trait) . setInputScale
// Arg ARG Primitive(double) scale= Primitive(double) = 
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_setInputScale_double(void* instance, double scale) {
    try {
...
// parsed: cv::dnn::Model::setInputCrop
// as:     cv::dnn::Model::setInputCrop (method) cv::dnn::Model (trait) . setInputCrop
// Arg ARG Primitive(bool) crop= Primitive(bool) = 
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_setInputCrop_bool(void* instance, bool crop) {
    try {
...
// parsed: cv::dnn::Model::setInputSwapRB
// as:     cv::dnn::Model::setInputSwapRB (method) cv::dnn::Model (trait) . setInputSwapRB
// Arg ARG Primitive(bool) swapRB= Primitive(bool) = 
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_setInputSwapRB_bool(void* instance, bool swapRB) {
    try {
...
// parsed: cv::dnn::Model::setInputParams
// as:     cv::dnn::Model::setInputParams (method) cv::dnn::Model (trait) . setInputParams
...
// Arg ARG Primitive(bool) crop= Primitive(bool) = false
// Return value: Primitive(void)
cv_return_value_void cv_dnn_Model_setInputParams_double_Size_Scalar_bool_bool(void* instance, double scale, SizeWrapper size, ScalarWrapper mean, bool swapRB, bool crop) {
    try {
        reinterpret_cast<cv::dnn::Model*>(instance)->setInputParams(scale, *reinterpret_cast<const cv::Size*>(&size), *reinterpret_cast<const cv::Scalar*>(&mean), swapRB, crop);
        return { Error::Code::StsOk, NULL };
    } CVRS_CATCH(cv_return_value_void)
}

// parsed: cv::dnn::Model::predict
// as:     cv::dnn::Model::predict (method) cv::dnn::Model (trait) . predict
// Arg ARG cv::_InputArray (boxed) frame= cv::_InputArray (boxed) = 
// Arg ARG cv::_OutputArray (boxed) outs= cv::_OutputArray (boxed) = 
// Return value: Primitive(void)
cv_return_value_void cv_dnn_Model_predict__InputArray__OutputArray(void* instance, void* frame, void* outs) {
    try {
        reinterpret_cast<cv::dnn::Model*>(instance)->predict(*reinterpret_cast<const cv::_InputArray*>(frame), *reinterpret_cast<cv::_OutputArray*>(outs));
        return { Error::Code::StsOk, NULL };
    } CVRS_CATCH(cv_return_value_void)
}

// boxed class: cv::dnn::Model
void cv_Model_delete(void* instance) {
    delete reinterpret_cast<cv::dnn::Model*>(instance);
}
// parsed: cv::dnn::Model::Model
// as:     cv::dnn::Model::Model (constructor) cv::dnn::Model (trait) . default
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_Model() {
    try {
...
// parsed: cv::dnn::Model::Model
// as:     cv::dnn::Model::Model (constructor) cv::dnn::Model (trait) . new
// Arg ARG string model= string = 
// Arg ARG string config= string = ""
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_Model_String_String(const char* model, const char* config) {
    try {
        cv::dnn::Model* ret = new cv::dnn::Model(String(model), String(config));
        return { Error::Code::StsOk, NULL, ret };
    } CVRS_CATCH(cv_return_value_void_X)
}
...
// Arg ARG cv::dnn::Net (boxed) network= cv::dnn::Net (boxed) = 
// Return value: cv::dnn::Model (boxed)
cv_return_value_void_X cv_dnn_Model_Model_Net(void* network) {
    try {
...
// as:     cv::dnn::Net::empty (method) cv::dnn::Net (trait) . empty
// Return value: Primitive(bool)
...
// as:     cv::dnn::Net::dump (method) cv::dnn::Net (trait) . dump
// Return value: string
...
// as:     cv::dnn::Net::dumpToFile (method) cv::dnn::Net (trait) . dumpToFile
// Arg ARG string path= string = 
// Return value: Primitive(void)
...
// as:     cv::dnn::Net::addLayer (method) cv::dnn::Net (trait) . addLayer
...
// as:     cv::dnn::Net::addLayerToPrev (method) cv::dnn::Net (trait) . addLayerToPrev
// Arg ARG string name= string = 
// Arg ARG string type= string = 
// Arg ARG cv::dnn::LayerParams (boxed) params= cv::dnn::LayerParams (boxed) = 
// Return value: Primitive(int)
...
// as:     cv::dnn::Net::getLayerId (method) cv::dnn::Net (trait) . getLayerId
...
// as:     cv::dnn::Net::getLayerNames (method) cv::dnn::Net (trait) . getLayerNames
...
// as:     cv::dnn::Net::getLayer (method) cv::dnn::Net (trait) . getLayer
...
// as:     cv::dnn::Net::getLayerInputs (method) cv::dnn::Net (trait) . getLayerInputs
// Arg ARG cv::dnn::DictValue (boxed) layerId= cv::dnn::DictValue (boxed) = 
...
// as:     cv::dnn::Net::connect (method) cv::dnn::Net (trait) . connect
...
// as:     cv::dnn::Net::setInputsNames (method) cv::dnn::Net (trait) . setInputsNames
...
// as:     cv::dnn::Net::forward (method) cv::dnn::Net (trait) . forward
...
// as:     cv::dnn::Net::setHalideScheduler (method) cv::dnn::Net (trait) . setHalideScheduler
...
// as:     cv::dnn::Net::setPreferableBackend (method) cv::dnn::Net (trait) . setPreferableBackend
// Arg ARG Primitive(int) backendId= Primitive(int) = 
// Return value: Primitive(void)
...
// as:     cv::dnn::Net::setPreferableTarget (method) cv::dnn::Net (trait) . setPreferableTarget
...
// as:     cv::dnn::Net::setInput (method) cv::dnn::Net (trait) . setInput
...
// as:     cv::dnn::Net::setParam (method) cv::dnn::Net (trait) . setParam
...
// as:     cv::dnn::Net::getParam (method) cv::dnn::Net (trait) . getParam
// Arg ARG cv::dnn::DictValue (boxed) layer= cv::dnn::DictValue (boxed) = 
...
// as:     cv::dnn::Net::getUnconnectedOutLayers (method) cv::dnn::Net (trait) . getUnconnectedOutLayers
// Return value: Vector[Primitive(int)]
...
// as:     cv::dnn::Net::getUnconnectedOutLayersNames (method) cv::dnn::Net (trait) . getUnconnectedOutLayersNames
// Return value: Vector[string]
...
// as:     cv::dnn::Net::getLayersShapes (method) cv::dnn::Net (trait) . getLayersShapes
...
// as:     cv::dnn::Net::getLayerShapes (method) cv::dnn::Net (trait) . getLayerShapes
// Arg ARG Vector[Vector[Primitive(int)]] netInputShapes= Vector[Vector[Primitive(int)]] = 
...
// as:     cv::dnn::Net::getFLOPS (method) cv::dnn::Net (trait) . getFLOPS
// Arg ARG Vector[Vector[Primitive(int)]] netInputShapes= Vector[Vector[Primitive(int)]] = 
// Return value: Primitive(int64)
...
// as:     cv::dnn::Net::getLayerTypes (method) cv::dnn::Net (trait) . getLayerTypes
...
// as:     cv::dnn::Net::getLayersCount (method) cv::dnn::Net (trait) . getLayersCount
...
// as:     cv::dnn::Net::getMemoryConsumption (method) cv::dnn::Net (trait) . getMemoryConsumption
// Arg ARG Vector[Vector[Primitive(int)]] netInputShapes= Vector[Vector[Primitive(int)]] = 
...
// as:     cv::dnn::Net::enableFusion (method) cv::dnn::Net (trait) . enableFusion
...
// as:     cv::dnn::Net::getPerfProfile (method) cv::dnn::Net (trait) . getPerfProfile
...
// as:     cv::dnn::Net::Net (constructor) cv::dnn::Net (trait) . default
// Return value: cv::dnn::Net (boxed)
...
// as:     cv::dnn::Net::readFromModelOptimizer (method) cv::dnn::Net (trait) . readFromModelOptimizer
// Arg ARG string xml= string = 
// Arg ARG string bin= string = 
// Return value: cv::dnn::Net (boxed)
...
// boxed class: cv::dnn::SegmentationModel
void cv_SegmentationModel_delete(void* instance) {
    delete reinterpret_cast<cv::dnn::SegmentationModel*>(instance);
}
// parsed: cv::dnn::SegmentationModel::SegmentationModel
// as:     cv::dnn::SegmentationModel::SegmentationModel (constructor) cv::dnn::SegmentationModel . new
// Arg ARG string model= string = 
// Arg ARG string config= string = ""
// Return value: cv::dnn::SegmentationModel (boxed)
cv_return_value_void_X cv_dnn_SegmentationModel_SegmentationModel_String_String(const char* model, const char* config) {
    try {
        cv::dnn::SegmentationModel* ret = new cv::dnn::SegmentationModel(String(model), String(config));
        return { Error::Code::StsOk, NULL, ret };
    } CVRS_CATCH(cv_return_value_void_X)
}
...
// Arg ARG cv::dnn::Net (boxed) network= cv::dnn::Net (boxed) = 
// Return value: cv::dnn::SegmentationModel (boxed)
cv_return_value_void_X cv_dnn_SegmentationModel_SegmentationModel_Net(void* network) {
    try {
...
// parsed: cv::dnn::SegmentationModel::segment
// as:     cv::dnn::SegmentationModel::segment (method) cv::dnn::SegmentationModel . segment
// Arg ARG cv::_InputArray (boxed) frame= cv::_InputArray (boxed) = 
// Arg ARG cv::_OutputArray (boxed) mask= cv::_OutputArray (boxed) = 
// Return value: Primitive(void)
cv_return_value_void cv_dnn_SegmentationModel_segment__InputArray__OutputArray(void* instance, void* frame, void* mask) {
    try {
        reinterpret_cast<cv::dnn::SegmentationModel*>(instance)->segment(*reinterpret_cast<const cv::_InputArray*>(frame), *reinterpret_cast<cv::_OutputArray*>(mask));
        return { Error::Code::StsOk, NULL };
    } CVRS_CATCH(cv_return_value_void)
}
